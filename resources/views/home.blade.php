...
<section class="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('about') }}" class="btn bg-white text-primary-600 hover:bg-gray-100 px-8 py-3 text-lg">
                Quero visitar
            </a>
            <a href="{{ route('events.index') }}" class="btn bg-primary-500 hover:bg-primary-700 px-8 py-3 text-lg">
...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-secondary-500 to-secondary-700 rounded-2xl p-12 text-white text-center">
            ...
            <a href="{{ route('youth') }}" class="btn bg-white text-secondary-600 hover:bg-gray-100">
                Conheça a juventude
            </a>
        </div>
    </div>
